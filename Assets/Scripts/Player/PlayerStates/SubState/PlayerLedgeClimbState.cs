...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    private void CheckForSpace()
    {
        isTouchingCeiling =
            Physics2D.Raycast(
                cornerPos + (Vector2.up * 0.015f) + (Vector2.right * 0.015f * core.Movement.FacingDirection),
    ...
    private Vector2 DetermineCornerPosition()
    {
        ...
        workSpaceVector.Set((xDist + 0.015f) * core.Movement.FacingDirection, 0f);
        RaycastHit2D yHit = Physics2D.Raycast(core.CollisionSenses.LedgeCheck.position + (Vector3)(workSpaceVector),
            Vector2.down,
        ...
        workSpaceVector.Set(core.CollisionSenses.WallCheck.position.x + (xDist * core.Movement.FacingDirection),
            core.CollisionSenses.LedgeCheck.position.y - yDist);
