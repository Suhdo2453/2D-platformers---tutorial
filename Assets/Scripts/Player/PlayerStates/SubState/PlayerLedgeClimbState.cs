...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    {
        isTouchingCeiling =
            Physics2D.Raycast(cornerPos + (Vector2.up * 0.015f) + (Vector2.right * 0.015f * player.FacingDirection), Vector2.up, playerData.standColliderHeight, playerData.whatIsGround);
